...
// Árvore de exemplo do recomendador: a pasta de queries só existe quando a
// recomendação inclui server state.
export function createBuilderTree(hasQueries: boolean): TreeNode {
